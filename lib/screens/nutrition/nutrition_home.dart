...
class NutritionHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final NutritionPlan plan = LocalDataService.sampleNutritionPlan;
    final settings = UserSettingsService.instance.settings;

    final weight = settings.weightKg ?? 70;
    final maintenanceCals = (weight * 30).round();
    int adjustedCalories;
    switch (settings.goal) {
      case 'Lose fat':
        adjustedCalories = maintenanceCals - 350;
        break;
      case 'Build muscle':
        adjustedCalories = maintenanceCals + 250;
        break;
      default:
    ...
    final fats = (weight * 0.8).round();
    final caloriesFromProtein = protein * 4;
    final caloriesFromFats = fats * 9;
    final caloriesFromCarbs = adjustedCalories - caloriesFromProtein - caloriesFromFats;
    final carbs = (caloriesFromCarbs / 4).round();
        ...
        child: ListView(
          ...
          children: [
            const AppSectionHeader(
              title: 'Nutrition',
              subtitle: 'Today\'s macro breakdown based on your current plan.',
            ),
            _MacroSummaryCard(
            ...
            const AppSectionHeader(title: 'Guidance'),
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _MacroChip(label: 'Fats', value: '${fats} g'),
              ],
            ),
            const SizedBox(height: 12),
            Wrap(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Guidance will appear here once a plan is configured.',
