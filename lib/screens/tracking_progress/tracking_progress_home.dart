...
class TrackingProgressHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveAge = settings.age ?? user.age;
    final effectiveHeight = settings.heightCm ?? user.heightCm;
    final effectiveWeight = settings.weightKg ?? user.weightKg;
    final effectiveGoal =
        settings.goal?.isNotEmpty == true ? settings.goal! : user.goal;
    final effectiveExperience = settings.experienceLevel?.isNotEmpty == true
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                if (age != null) AssistChip(label: Text('Age: $age')),
                if (heightCm != null)
                  AssistChip(label: Text('Height: ${heightCm!.toStringAsFixed(0)} cm')),
                if (weightKg != null)
                  AssistChip(label: Text('Weight: ${weightKg!.toStringAsFixed(1)} kg')),
                if (experienceLevel != null && experienceLevel!.isNotEmpty)
                  AssistChip(label: Text('Level: $experienceLevel')),
              ],
            ),
          ...
          ? Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Once you start tracking, your history will appear here.',
